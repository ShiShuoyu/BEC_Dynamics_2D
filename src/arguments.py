...
def input_args() -> ArgumentParser:
    ...
    parser.add_argument('--scattering_length', type=cp.float32, default=50,
    ...
    parser.add_argument('--omega_trap', type=cp.float32, default=0.01*np.pi, 
    ...
    parser.add_argument('--omega_trap_z', type=cp.float32, default=0.005*np.pi, 
